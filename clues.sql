...
WHERE countrycode = (SELECT code FROM countries WHERE name = 'Andorra') AND isofficial = TRUE;
...
SELECT name
FROM cities
WHERE countrycode = (SELECT code FROM countries WHERE name = 'Andorra')
AND name != 'Andorra';
...
AND c.name LIKE 'SomeCityName%'
AND c.name != 'SomeCityName';
...
SELECT name
FROM cities
WHERE countrycode = (SELECT code FROM countries WHERE name = 'Argentina') AND capital = 1;
